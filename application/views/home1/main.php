...
<!-- Stats -->
	<script src="<?=base_url();?>assets/home1/js/waypoints.min.js"></script> 
	<script src="<?=base_url();?>assets/home1/js/counterup.min.js"></script> 
	<script>
...
<!-- //for bootstrap working -->
<!-- carousal -->
	<script src="<?=base_url();?>assets/home1/js/slick.js" type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript">
...
<!-- //carousal -->
<!-- gauge-meter -->
	<script src="<?=base_url();?>assets/home1/js/jquery.gauge.js"></script>
	<script>
		$(document).ready(function (){
