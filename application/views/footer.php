			...
			<div class="w3_agile_footer_grids">
				...
				<div class="col-md-4 w3_agile_footer_grid">
					...
					<div class="w3_agileits_footer_grid_left">
						<a href="#"><img src="<?=base_url();?>assets/images/s6.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="w3_agileits_footer_grid_left">
						<a href="#"><img src="<?=base_url();?>assets/images/s2.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="w3_agileits_footer_grid_left">
						<a href="#"><img src="<?=base_url();?>assets/images/s1.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="w3_agileits_footer_grid_left">
						<a href="#"><img src="<?=base_url();?>assets/images/s3.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="w3_agileits_footer_grid_left">
						<a href="#"><img src="<?=base_url();?>assets/images/s4.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="w3_agileits_footer_grid_left">
						<a href="#"><img src="<?=base_url();?>assets/images/s5.jpg" alt=" " class="img-responsive" /></a>
					</div>
