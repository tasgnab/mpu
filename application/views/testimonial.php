						...
						<div class="agileits_testimonial_grid">
							<div class="w3l_testimonial_grid">
								...
								<div class="w3l_testimonial_grid_pos">
									<img src="<?=base_url();?>assets/images/1.png" alt=" " class="img-responsive" />
								</div>
							</div>
						</div>
						<div class="agileits_testimonial_grid">
							<div class="w3l_testimonial_grid">
								...
								<h5>Student</h5>
								<div class="w3l_testimonial_grid_pos">
									<img src="<?=base_url();?>assets/images/2.png" alt=" " class="img-responsive" />
								</div>
							</div>
						</div>
						<div class="agileits_testimonial_grid">
							<div class="w3l_testimonial_grid">
								...
								<h5>Student</h5>
								<div class="w3l_testimonial_grid_pos">
									<img src="<?=base_url();?>assets/images/3.png" alt=" " class="img-responsive" />
								</div>
							</div>
						</div>
				</section>
